...
::setup( const bool led_mode, const bool resolution , const bool Busy, const bool Serial_NPU, const bool NAGC, const bool Fixed_FR) {
  ...
  //Mở rộng                         register writing                Shutter     Framerate
  uint8_t extend_config = B00000000 | Busy << 7 | Serial_NPU << 2 | NAGC << 1 | Fixed_FR;
  writeRegister( ADNS3080_Extended_Config, extend_config );
...
//Mở rộng của thư viện gốc
// Get Pixel Sum (0x06) after frame capture
template<TEMPLATE_TYPE>
uint8_t ADNS3080<TEMPLATE_INPUTS>
::readPixelSum() {
